package com.completeperspective.media.utils
{
	import com.completeperspective.media.events.BandwidthEvent;
	...
	public class BandwidthTest extends EventDispatcher
	{
		...
		private function handleLoad( e : Event ) : void
		{
			...
			if ( _downloadCount == 1) {
				...
				trace( thumb );
				dispatchEvent( new BandwidthEvent( BandwidthEvent.THUMBNAIL_RECEIVED, thumb ) );
		...
		private function dispatchCompleteEvent() : void
		{
			...
			dispatchEvent( new BandwidthEvent( BandwidthEvent.BANDWIDTH_RECEIVED, _detectedBandwidth ) );
		}
